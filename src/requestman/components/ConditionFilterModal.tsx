...
import { AutoComplete, Form, Input, Modal, Select, Space } from 'antd';
import {
    ...
    <Modal open={open} title="过滤条件" onCancel={onClose} onOk={onClose}>
      {condition && (
        <Form layout="vertical" size="small">
          <Form.Item label="页面域名" style={{ marginBottom: 12 }}>
            <Input
          ...
          <Form.Item label="请求 Header 过滤" style={{ marginBottom: 0 }}>
